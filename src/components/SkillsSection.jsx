...
const skills = [
  ...
  { name: "Pandas", level: 60, category: "backend" },
  { name: "NumPy", level: 60, category: "backend" },
  { name: "Scikit-learn", level: 60, category: "backend" },
  { name: "OpenAI API / LLM Integration", level: 60, category: "backend" },
  { name: "Inngest", level: 60, category: "backend" },
